		...
		<div class="col-lg-6">
			<div class="panel clearfix">
				...
				<div class="form-horizontal">
					...
					<div class="row">
						<label class="control-label col-lg-3">{l s='Código Referencia Vendedor'}</label>
						<div class="col-lg-9">
								<p class="form-control-static" style="text-decoration:underline;"><i>
								{if isset($customer->seller_code)}
								{$customer->seller_code}
								{else}
								{l s='Unknown'}
								{/if}
								</i></p>
					...
					<div class="row">
						<label class="control-label col-lg-3">{l s='Client type'}</label>
						<div class="col-lg-9">
								<p class="form-control-static" style="font-weight:700;">
								{if isset($customer->seller_code_profile)}
								{$customer->seller_code_profile}
								{else}
								{l s='Unknown'}
								{/if}
								</p>
