...
class AdminCustomersControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'seller_code_profile' => array(
                'title' => $this->trans('Client type', array(), 'Admin.Global')
            ),
            'seller_code' => array(
                'title' => $this->trans('Seller Code', array(), 'Admin.Global')
            ),
        ...
        a.date_add, gl.name as title, (
            ...
            LIMIT 1
        ) as connect, seller_code, seller_code_profile';
    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                /*Mostrar y editar el campo en la pestaña Clientes Seller_code */
                array(
                    'type' => 'text',
                    'label' => $this->trans('Type', array(), 'Admin.Global'),
                    'name' => 'seller_code_profile',
                    'col' => '4',
                    ),
                array(
                    'type' => 'text',
                    'label' => $this->trans('Referencia Vendedor', array(), 'Admin.Global'),
                    'name' => 'seller_code',
                    'col' => '4',
                    ),
                array(
