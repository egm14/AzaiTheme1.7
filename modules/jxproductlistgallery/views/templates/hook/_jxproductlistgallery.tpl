<<<<<<< HEAD:modules/jxproductlistgallery/views/templates/hook/_jxproductlistgallery.tpl
<<<<<<< HEAD
{*
* 2017-2018 Zemez
*
...
{if $smarty_settings.st_display}
  ...
  {/if}
{/if}
>>>>>>> 683df2775cd4f092c0c980c597ca9df83d2d25c5
=======
{*
* 2017-2018 Zemez
*
...
="{$urls.theme_assets}OtherFile/img_small_default.png"
  ...
  {/if}
{/if}
>>>>>>> dev:modules/jxproductlistgallery/views/templates/hook/jxproductlistgallery.tpl
