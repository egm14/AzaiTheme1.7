        ...
        <div class="quotationspro_request notes col-lg-12" style="margin-bottom:2rem;">
            <div class="row button-container">
                ...
                <div class="customer-copy-checkbox offset-lg-4 col-lg-2">
                    <div class="row">
                        <label class="field-label pull-right" for="ROJA45QUOTATIONSPRO_CUSTOMER_COPY"><input type="checkbox" class="form-control" id="ROJA45QUOTATIONSPRO_CUSTOMER_COPY" name="ROJA45QUOTATIONSPRO_CUSTOMER_COPY" checked/> {l s='Send copy to yourself' mod='roja45quotationspro'}</label>
                    </div>
                </div>
            </div>
        </div>
