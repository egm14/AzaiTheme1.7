...
<tr>
    ...
    <td colspan=2 style="border:0px solid #D6D4D4;">
        <table class="table">
            <tr>
                <td>
                    <span style="color: #444444;font-family: Helvetica, 'Open Sans', Arial, sans-serif;font-size: 13px;">{$product.product_price_subtotal_excl_formatted*$packageAzai|escape:'htmlall':'UTF-8'}</span>
                </td>
            </tr>
        </table>
    </td>
