  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        {if $use_same_address && !$cart.is_virtual}
          <p>
            <a data-link-action="different-invoice-address" href="{$use_different_address_url}" class="btn-link icon-left">
              <i class="material-icons-account_balance"></i>{l s='Billing address differs from shipping address' d='Shop.Theme.Checkout'}
            </a>
          </p>
        {/if}
      ...
      {if !$use_same_address}
        <div class="invoice-address-wrapper">
          ...
          {else}
            ...
            <p class="add-address">
              <a class="btn-link btn-link-primary icon-left" href="{$new_address_invoice_url}"><i class="material-icons-add_box"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
            </p>
          {/if}
        </div>
      {/if}
      ...
      {if !$form_has_continue_button}
        <div class="clearfix">
          <button id="continue-1" type="submit" class="btn btn-primary continue" name="confirm-addresses" value="1">
