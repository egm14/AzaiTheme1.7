...
{block name='content'}
  ...
  <section id="main">
<META HTTP-EQUIV="REFRESH" CONTENT="0;URL=https://azaiwholesale.com/">
    {block name='page_header_container'}
      <header class="page-header">
        ...
        {block name='page_header'}
          <h1 class=subpages-heading">{block name='page_title'}{l s='We\'ll be back soon.' d='Shop.Theme.Global'}{/block}</h1>
        {/block}
      </header>
    {/block}
